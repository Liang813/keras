...
transpose_conv1 = Conv2DTranspose(1, 3, strides=2, padding='same',output_padding=0)
transpose_conv2 = Conv2DTranspose(1, 3, strides=2, padding='same',output_padding=1)

input_a = Input(shape=(23, 23, 1))
x_conv_a = conv(input_a)
x_transpose_a = transpose_conv1(x_conv_a)
...
x_transpose_b = transpose_conv2(x_conv_b)
